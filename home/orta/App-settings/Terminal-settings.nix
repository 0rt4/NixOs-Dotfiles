...

{
  programs.fish = {
    ...
    shellAliases = {
      ...
      # NixOS
      rebuild = "/etc/nixos/modules/scripts/rebuild";
      rebuild-cybersecurity = "/etc/nixos/modules/scripts/rebuild-cybersecurity";
      
      update = "/etc/nixos/modules/scripts/update";
      update-cybersecurity = "/etc/nixos/modules/scripts/update-cybersecurity";

      # Scripts extras
      screenshot = "/etc/nixos/modules/scripts/screenshot";
