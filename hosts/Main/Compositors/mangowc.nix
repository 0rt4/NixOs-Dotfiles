...

{
  ...
  environment.etc."mango/config.conf".text = ''
    ...
    monitorrule=name:^HDMI-A-2$,width:1360,height:768,refresh:60,x:1920,y:0
    focus_on_activate=1
    ...
    bind=SUPER,v,spawn,noctalia-shell ipc call clipboard toggle
    bind=SUPER,m,spawn,noctalia-shell ipc call processlist focusOrToggle
    bind=SUPER,comma,spawn,noctalia-shell ipc call settings focusOrToggle
    bind=SUPER,n,spawn,noctalia-shell ipc call notifications toggle
    bind=SUPER,y,spawn,noctalia-shell ipc call dankdash wallpaper
